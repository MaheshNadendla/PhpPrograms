<?php
    ...
    if($conn)
    {
        ...
        if (mysqli_num_rows($result1) > 0) 
        {
            ...
            $sql = "SELECT * FROM girlshomehistory";
            ...
            if (mysqli_num_rows($result5) > 0)
            {
                ...
                while ($row = mysqli_fetch_row($result5)) 
                {
                    ...
                    if($row[0]==$bhi  &&  $row[6]=="out")
                    {
                        ...
                        $sql_update1 = "UPDATE `girlshomehistory` SET `intime`= current_timestamp() WHERE `status` = 'out' ";

                        $sql_update = "UPDATE `girlshomehistory` SET `status` = 'out-in' WHERE id = $bhi ";
        ...
        elseif($flag1==1 && $flag2==0  && $flag3==0  && $flag4==1 )
        {
            ...
            $sql="DELETE FROM `girlshomeout` WHERE `id` = '$id'";
        ...
        elseif($flag1==1 && $flag2==1  && $flag3==0  && $flag4==0 )
        {
            ...
            echo "<div class='Error-Messages'> <div class='MessageBox' > 
            She is At Outing <br> Come in Outing In List
            </div>
            </div>";
