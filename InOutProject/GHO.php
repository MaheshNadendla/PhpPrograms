<?php
    ...
    $bhoroll=$_POST['GirlsHomeOutRoll'];
    $bhoplace=$_POST['GirlsHomeOutPlace'];
    ...
    if($conn)
    {
        ...
        echo'<div class="heading"> Girls Home List</div>';
        ...
        elseif($flag1==1 && $flag2==0  && $flag3==1  && $flag4==0 )
        {
            ...
            $sql="INSERT INTO `girlshomeout` (`id`, `name`, `phone`, `place`, `intime`, `outime`, `status`) VALUES ('$id', '$name', '$phone', '$bhoplace','-', current_timestamp(), 'out');";
            $x=mysqli_query($conn,$sql);

            $sql="INSERT INTO `girlshomehistory` (`id`, `name`, `phone`, `place`, `intime`, `outime`, `status`) VALUES ('$id', '$name', '$phone', '$bhoplace', '-' , current_timestamp(), 'out');";
            $x=mysqli_query($conn,$sql);
        ...
        elseif($flag1==1 && $flag2==0  && $flag3==0  && $flag4==1 )
        {
           ...
           She Is At home <br> Can't Send Home
                </div>
                </div>";
